...
class BaseEndpoint:
    ...
    def _make_request(self, method: str, path: str, operation_id: Optional[str] = None, 
                     cast_response: bool = True, **kwargs):
        ...
        if cast_response:
            return self._cast_response(response, method, f"/api/{full_path}", operation_id)
