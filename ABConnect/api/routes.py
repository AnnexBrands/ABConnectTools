...
SCHEMA = {
    ...
    "CONTACTS": {
        ...
        "GET_USER": Route("GET", "/contacts/user", None, "Contact", {}),
        "POST_CUSTOMERS": Route("POST", "/contacts/customers", "SearchContactRequest", "ServiceBaseResponse", {}),
        ...
        "POST_SEARCH": Route("POST", "/contacts/search", "WebApiDataSourceLoadOptions", "ServiceBaseResponse", {}),
        ...
        "PUT_MERGE": Route("PUT", "/contacts/{mergeToId}/merge", "MergeContactsRequestModel", "ServiceBaseResponse", {}),
    },
    "DASHBOARD": {
        "GET": Route("GET", "/dashboard", None, None, {}),
        "GET_GRIDVIEWS": Route("GET", "/dashboard/gridviews", None, "List[GridViewDetails]", {}),
        "GET_GRIDVIEWSTATE": Route("GET", "/dashboard/gridviewstate/{id}", None, "GridViewDetails", {}),
    ...
    "DOCUMENTS": {
        "GET_GET": Route("GET", "/documents/get/{docPath}", None, "DocumentDetails", {}),
        "GET_GET_THUMBNAIL": Route("GET", "/documents/get/thumbnail/{docPath}", None, None, {}),
        "GET_LIST": Route("GET", "/documents/list", None, "List[DocumentDetails]", {}),
        "POST": Route("POST", "/documents", None, "ServiceBaseResponse", {}),
        "PUT_HIDE": Route("PUT", "/documents/hide/{docId}", None, "ServiceBaseResponse", {}),
        "PUT_UPDATE": Route("PUT", "/documents/update/{docId}", "DocumentUpdateModel", "ServiceBaseResponse", {}),
    },
    "E_SIGN": {
    ...
    "EMAIL": {
        "POST_LABELREQUEST": Route("POST", "/email/{jobDisplayId}/labelrequest", None, "ServiceBaseResponse", {}),
    },
    "JOB": {
    ...
    "JOBINTACCT": {
        ...
        "POST_APPLY_REBATE": Route("POST", "/jobintacct/{jobDisplayId}/applyRebate", None, "ServiceBaseResponse", {}),
        "POST_DRAFT": Route("POST", "/jobintacct/{jobDisplayId}/draft", "CreateJobIntacctModel", "ServiceBaseResponse", {}),
    },
    "LOOKUP": {
        ...
        "GET_ACCESS_KEYS": Route("GET", "/lookup/accessKeys", None, "List[LookupValue]", {}),
        ...
        "GET_DOCUMENT_TYPES": Route("GET", "/lookup/documentTypes", None, "List[LookupValue]", {}),
        "GET_ITEMS": Route("GET", "/lookup/items", None, None, {}),
        "GET_PARCEL_PACKAGE_TYPES": Route("GET", "/lookup/parcelPackageTypes", None, "List[LookupValue]", {}),
    ...
    "REPORTS": {
        ...
        "POST_SALES_DRILLDOWN": Route("POST", "/reports/salesDrilldown", "Web2LeadRevenueFilter", "ServiceBaseResponse", {}),
    ...
    "RFQ": {
        ...
        "GET_FORJOB": Route("GET", "/rfq/forjob/{jobId}", None, "List[QuoteRequestDisplayInfo]", {}),
        "POST_ACCEPT": Route("POST", "/rfq/{rfqId}/accept", "AcceptModel", "ServiceBaseResponse", {}),
        "POST_ACCEPTWINNER": Route("POST", "/rfq/{rfqId}/acceptwinner", None, "ServiceBaseResponse", {}),
        "POST_CANCEL": Route("POST", "/rfq/{rfqId}/cancel", None, "ServiceBaseResponse", {}),
        "POST_COMMENT": Route("POST", "/rfq/{rfqId}/comment", None, "ServiceBaseResponse", {}),
        "POST_DECLINE": Route("POST", "/rfq/{rfqId}/decline", None, "ServiceBaseResponse", {}),
    },
    "SHIPMENT": {
        "GET": Route("GET", "/shipment", None, "ShipmentDetails", {}),
        "GET_ACCESSORIALS": Route("GET", "/shipment/accessorials", None, "List[JobParcelAddOn]", {}),
    ...
    "SMSTEMPLATE": {
        ...
        "GET_LIST": Route("GET", "/SmsTemplate/list", None, "List[SmsTemplateModel]", {}),
        "GET_NOTIFICATION_TOKENS": Route("GET", "/SmsTemplate/notificationTokens", None, None, {}),
        "POST_SAVE": Route("POST", "/SmsTemplate/save", "SmsTemplateModel", "ServiceBaseResponse", {}),
    },
    "USERS": {
        "GET_POCUSERS": Route("GET", "/users/pocusers", None, "List[Users]", {}),
        "GET_ROLES": Route("GET", "/users/roles", None, None, {}),
        "POST_LIST": Route("POST", "/users/list", "WebApiDataSourceLoadOptions", "ServiceBaseResponse", {}),
        "POST_USER": Route("POST", "/users/user", "CreateUserModel", "ServiceBaseResponse", {}),
        "PUT_USER": Route("PUT", "/users/user", "UserInfo", "ServiceBaseResponse", {}),
    },
    "V2": {
        "GET_JOB_TRACKING": Route("GET", "/v2/job/{jobDisplayId}/tracking/{historyAmount}", None, "ShipmentTrackingDetails", {}),
    },
    "V3": {
    ...
    "VIEWS": {
        ...
        "GET_ACCESSINFO": Route("GET", "/views/{viewId}/accessinfo", None, "GridViewAccess", {}),
        "GET_ALL": Route("GET", "/views/all", None, "List[GridViewDetails]", {}),
