...
SCHEMA = {
    ...
    "COMPANIES": {
        ...
        "GET_COMPANY_GEOSETTINGS": Route("GET", "/companies/{companyId}/geosettings", None, "List[SaveGeoSettingModel]", {}),
    ...
    "JOB": {
        ...
        "POST_TIMELINE": Route("POST", "/job/{jobDisplayId}/timeline", None, "SaveResponseModel", {}),
